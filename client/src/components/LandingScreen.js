    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            {["circle", "square", "triangle", "cross", "star"].map(
              (shape, i) => (
                <div
                  key={shape}
          ...
          >
            ...
            <button
              ...
              style={{
                padding: "16px",
                fontSize: 13,
                opacity: !selectedGameMode ? 0.5 : 1,
              }}
          ...
          >
            ...
            <div>
              ...
              <input
                value={roomCode}
                onChange={(e) =>
                  !codeLocked && setRoomCode(e.target.value.toUpperCase())
                }
