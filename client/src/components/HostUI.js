...
export function HostUI({
  ...
  const executeConfirm = () => {
    ...
    if (confirmAction.type === "roundWin")
      declareRoundWin(confirmAction.payload);
    ...
    >
      ...
      >
        <div>
          <h1
            className="glitch"
            style={{ fontSize: 52, color: "var(--accent)", lineHeight: 1 }}
          >
            BLUFF
          </h1>
          <div
        ...
        >
          <div style={{ textAlign: "right" }}>
            ...
            <div
              style={{ fontSize: 9, color: "var(--text-dim)", marginTop: 4 }}
            >
      ...
      >
        <div
          style={{
            ...
            color:
              isBluffResolution || isSpinPending
                ? "var(--accent2)"
                : isGameOver
                  ? "var(--accent)"
                  : isRoundEnd
        ...
        >
          ...
          {isSpinPending &&
            `🔫 Waiting for ${spinTargetPlayer?.username ?? "..."} to spin`}
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          ...
          {isBluffResolution && (
            <div style={{ width: "100%" }}>
              ...
              >
                The current player called bluff on the previous player's last
                card.
                <br />
                <span style={{ color: "var(--text-dim)" }}>
                  Physically reveal the last card played, then confirm:
                </span>
              </div>
              <div
                style={{
          ...
          {isSpinPending && (
            ...
            >
              🔫 Waiting for{" "}
              <strong>{spinTargetPlayer?.username ?? "..."}</strong> to pull the
              trigger...
            </div>
          )}
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
              ...
              <button className="success" onClick={executeConfirm}>
                Confirm
              </button>
            </div>
          </div>
